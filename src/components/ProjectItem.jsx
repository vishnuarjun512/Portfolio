    ...
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r hover:scale-[1.0150] from-gray-200 to-[#001b5e] ease-in-out duration-700">
      ...
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        ...
        <div className="md:mt-[-8px] mt-[2px]">
          ...
          <a href={link}>
            <p className="sm:text-[13px] text-[13px] flex items-center justify-center sm:gap-[12px] gap-[1px] text-center p-3 rounded-lg bg-white text-gray-700 font-bold cursor-pointer hover:scale-110 ease-in duration-200">
              <FaGithub className="w-[40px] h-[40px]" />
              <p className="p-0 w-[90%]">Click to check source code</p>
            </p>
          </a>
        </div>
      </div>
