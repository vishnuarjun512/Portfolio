...
const ProjectItem = ({ img, title, link, tech, hosted }) => {
  ...
  return (
    <div
      ...
      } max-w-[100%] relative flex items-center justify-center h-full w-full  shadow-gray-400 rounded-xl group hover:bg-gradient-to-b hover:scale-105 from-gray-700 to-[#14131a] ease-in-out duration-700`}
    >
      <img
